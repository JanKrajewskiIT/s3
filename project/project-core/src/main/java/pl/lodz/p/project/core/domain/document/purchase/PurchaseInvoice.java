...
public class PurchaseInvoice extends Document<Long> {
    ...
    private Set<PurchaseInvoiceGood> invoiceGoodList;
    ...
    public Set<PurchaseInvoiceGood> getInvoiceGoodList() {
        return invoiceGoodList;
    }

    public void setInvoiceGoodList(Set<PurchaseInvoiceGood> invoiceGoodList) {
