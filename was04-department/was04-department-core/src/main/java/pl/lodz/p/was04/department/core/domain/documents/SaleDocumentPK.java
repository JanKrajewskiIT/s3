 ...
 */
@Embeddable
public class SaleDocumentPK implements Serializable {
    ...
    public SaleDocumentPK() {
    }

    public SaleDocumentPK(String symbol, Long warehouseId) {
        this.symbol = symbol;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SaleDocumentPK)) {
            return false;
        }
        SaleDocumentPK other = (SaleDocumentPK) object;
    ...
    public String toString() {
        return "pl.lodz.p.was04.headoffice.entity.documents.SaleDocumentsPK[ symbol=" + symbol + ", warehouseId=" + warehouseId + " ]";
    }
